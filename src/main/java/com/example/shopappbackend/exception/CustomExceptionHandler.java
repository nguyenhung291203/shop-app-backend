...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<ErrorException<String>> handleAlreadyExistedException(
    ...
    public ResponseEntity<ErrorException<String>> handleDataIntegrityViolationException(
    ...
    public ResponseEntity<ErrorException<List<String>>> handleValidationException(
    ...
    public ResponseEntity<ErrorException<String>> globeExceptionable(Exception ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorException<String>> handleUnauthorizedException(
